export const abiZKHIVE = [
  ...
  {
    inputs: [{ internalType: "uint256", name: "maxHolding_", type: "uint256" }],
    name: "setMaxHolding",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [
      { internalType: "uint256", name: "maxTxAmount_", type: "uint256" },
    ],
    name: "setMaxTxAmount",
    outputs: [],
    stateMutability: "nonpayable",
